...
12) Create a shell script that runs the command of curator and leave it in the crontab daily folder (sudo cp src/main/elastic_curator.sh /etc/cron.daily/) which involves that command automatically executing it daily.
